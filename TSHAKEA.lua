...
download_to_file('https://github.com/TSHAKEAD/TSHAKEA/master/TSHAKEA.lua', 'TSHAKEA.lua') 
download_to_file('https://github.com/TSHAKEAD/TSHAKEA/master/start.lua', 'start.lua') 
dofile('TSHAKEA.lua')  
return false
end
