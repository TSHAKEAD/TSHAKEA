...
function DevBot(msg) 
local hash = database:sismember(bot_id.."TshakeA:Sudo:User", msg.sender_user_id_) 
if hash or DevTshakeA(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevTshakeA(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."TshakeA:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevTshakeA(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."TshakeA:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevTshakeA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."TshakeA:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevTshakeA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."TshakeA:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevTshakeA(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./TshakeA');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TshakeA.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
function Rank_Checking(user_id,chat_id)
if tonumber(user_id) == tonumber(Id_Sudo) then
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = true  
elseif database:sismember(bot_id.."TshakeA:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."TshakeA:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."TshakeA:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TshakeA:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TshakeA:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."TshakeA:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
if DevTshakeAe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."TshakeA:Sudo:User", user_id) then
var = database:get(bot_id.."TshakeA:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."TshakeA:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."TshakeA:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."TshakeA:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."TshakeA:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."TshakeA:Manager"..chat_id, user_id) then
var = database:get(bot_id.."TshakeA:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."TshakeA:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."TshakeA:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."TshakeA:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."TshakeA:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."TshakeA:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."TshakeA:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."TshakeA:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."TshakeA:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."TshakeA:GBan:User",User_id) then
Var = true
else
Var = false
end
...
local UserName = (data.username_ or "Chucky_A ")
...
database:sadd(bot_id..'TshakeA:Chek:Groups',idg) 
database:set(bot_id.."TshakeA:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'TshakeA:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."TshakeA:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."TshakeA:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."TshakeA:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."TshakeA:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."TshakeA:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function TshakeA_Files(msg)
for v in io.popen('ls TshakeA_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("TshakeA_Files/"..v)
if plugin.TshakeA and msg then
pre_msg = plugin.TshakeA(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function TshakeA_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'TshakeA:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'TshakeA:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."TshakeA:TshakeA:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."TshakeA:TshakeA:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."TshakeA:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'TshakeA:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'TshakeA:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'TshakeA:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'TshakeA:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."TshakeA:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."TshakeA:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TshakeA:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."TshakeA:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."TshakeA:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."TshakeA:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TshakeA:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TshakeA:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."TshakeA:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."TshakeA:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."TshakeA:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."TshakeA:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."TshakeA:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."TshakeA:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."TshakeA:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."TshakeA:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."TshakeA:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."TshakeA:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."TshakeA:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."TshakeA:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."TshakeA:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."TshakeA:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TshakeA:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء وضع الوصف") 
database:del(bot_id.."TshakeA:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."TshakeA:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TshakeA:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء حفظ الترحيب") 
database:del(bot_id.."TshakeA:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."TshakeA:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."TshakeA:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"📮┇تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."TshakeA:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"📥┇تم الغاء حفظ الرابط")       
database:del(bot_id.."TshakeA:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."TshakeA:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."TshakeA:TshakeA:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه للخاص") 
database:del(bot_id.."TshakeA:TshakeA:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'TshakeA:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."TshakeA:TshakeA:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."TshakeA:TshakeA:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."TshakeA:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."TshakeA:TshakeA:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."TshakeA:TshakeA:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."TshakeA:TshakeA:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."TshakeA:TshakeA:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."TshakeA:UsersBot")   
...
if TshakeA_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..TshakeA_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."TshakeA:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."TshakeA:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TshakeA:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."TshakeA:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "📥┇ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."TshakeA:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."TshakeA:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇ارسل الامر الجديد")  
database:del(bot_id.."TshakeA:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."TshakeA:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."TshakeA:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."TshakeA:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."TshakeA:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."TshakeA:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇تم حفظ الامر")  
database:del(bot_id.."TshakeA:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."TshakeA:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."TshakeA:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."TshakeA:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."TshakeA:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."TshakeA:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."TshakeA:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."TshakeA:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."TshakeA:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."TshakeA:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'TshakeA:'..lock..msg.chat_id_,"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'TshakeA:'..lock..msg.chat_id_)    
end
...
if text == ("مسح قائمه العام") and DevTshakeA(msg) then
database:del(bot_id.."TshakeA:GBan:User")
send(msg.chat_id_, msg.id_, "\n📮┇تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevTshakeA(msg) then
database:del(bot_id.."TshakeA:Sudo:User")
send(msg.chat_id_, msg.id_, "\n📮┇ تم مسح قائمة المطورين  ")
end
if text == "مسح المنشئين الاساسين" and DevBot(msg) then
database:del(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_)
...
if text == ("قائمه العام") and DevTshakeA(msg) then
local list = database:smembers(bot_id.."TshakeA:GBan:User")
t = "\n⛔┇قائمة المحظورين عام \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TshakeA:User:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.."`)\n"
...
if text == ("المطورين") and DevTshakeA(msg) then
local list = database:smembers(bot_id.."TshakeA:Sudo:User")
t = "\n⛔┇قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."TshakeA:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."TshakeA:Special:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTshakeA(msg) then
...
database:sadd(bot_id.."TshakeA:GBan:User", result.sender_user_id_)
...
if text and text:match("^حظر عام @(.*)$")  and DevTshakeA(msg) then
...
database:sadd(bot_id.."TshakeA:GBan:User", result.id_)
...
if text and text:match("^حظر عام (%d+)$") and DevTshakeA(msg) then
...
database:sadd(bot_id.."TshakeA:GBan:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم حظره عام من المجموعات")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTshakeA(msg) then
function Function_TshakeA(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTshakeA(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_TshakeA(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","💢┇تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."TshakeA:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and DevTshakeA(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."TshakeA:GBan:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTshakeA(msg) then
function Function_TshakeA(extra, result, success)
database:sadd(bot_id.."TshakeA:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TshakeA, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevTshakeA(msg) then
...
database:sadd(bot_id.."TshakeA:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevTshakeA(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."TshakeA:Sudo:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTshakeA(msg) then
function Function_TshakeA(extra, result, success)
database:srem(bot_id.."TshakeA:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TshakeA, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevTshakeA(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevTshakeA(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."TshakeA:Sudo:User", userid)
...
database:sadd(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_, result.id_)
...
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TshakeA:Constructor"..msg.chat_id_, result.id_)
...
function Function_TshakeA(extra, result, success)
database:srem(bot_id.."TshakeA:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TshakeA, nil)
end
...
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Constructor"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","💢┇تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
...
database:sadd(bot_id.."TshakeA:Manager"..msg.chat_id_, result.id_)
...
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Manager"..msg.chat_id_, result.id_)
...
function Function_TshakeA(extra, result, success)
database:sadd(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TshakeA:Mod:User"..msg.chat_id_, userid)
...
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.id_)
...
function Function_TshakeA(extra, result, success)
database:sadd(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TshakeA:Special:User"..msg.chat_id_, userid)
...
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.id_)
...
local TshakeArt = database:get(bot_id.."TshakeA:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if TshakeArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."TshakeA:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif TshakeArt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."TshakeA:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif TshakeArt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."TshakeA:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif TshakeArt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif TshakeArt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if result.id_ then
local TshakeArt = database:get(bot_id.."TshakeA:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if TshakeArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."TshakeA:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif TshakeArt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."TshakeA:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif TshakeArt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n🔰┇تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."TshakeA:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."TshakeA:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TshakeA:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TshakeA:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."TshakeA:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."TshakeA:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."TshakeA:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."TshakeA:Muted:User"..msg.chat_id_, userid)
...
function Function_TshakeA(extra, result, success)
if result.id_ then
database:srem(bot_id.."TshakeA:Muted:User"..msg.chat_id_, result.id_)
...
database:set(bot_id.."TshakeA:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."TshakeA:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"💢┇انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"📫┇ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
...
local link = database:get(bot_id.."TshakeA:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."TshakeA:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TshakeA:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local TshakeA_Msg = database:get(bot_id.."TshakeA:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TshakeA_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."TshakeA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TshakeA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"📫┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TshakeA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TshakeA:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TshakeA:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TshakeA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."TshakeA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TshakeA:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TshakeA:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TshakeA:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."TshakeA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TshakeA:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TshakeA:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."TshakeA:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "📫┇تم الغاء حفظ القوانين") 
database:del(bot_id.."TshakeA:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."TshakeA:Set:Rules:Group" .. msg.chat_id_,text) 
...
for k,v in pairs(list) do
Cmds = database:get(bot_id.."TshakeA:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."TshakeA:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."TshakeA:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."TshakeA:List:Cmd:Group:New"..msg.chat_id_)
end
...
for k,v in pairs(list) do
var = database:get(bot_id.."TshakeA:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."TshakeA:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."TshakeA:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."TshakeA:Coomds"..msg.chat_id_)
end
...
database:setex(bot_id.."TshakeA:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
if database:get(bot_id.."TshakeA:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"☑┇تم الغاء الامر ") 
database:del(bot_id.."TshakeA:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."TshakeA:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."TshakeA:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."TshakeA:Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المطور الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ الاساسي (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ الاساسي (.*)$") 
database:set(bot_id.."TshakeA:BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المنشئ الاساسي الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."TshakeA:Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المنشئ الى » "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
database:set(bot_id.."TshakeA:Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المدير الى » "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
database:set(bot_id.."TshakeA:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد الادمن الى » "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
database:set(bot_id.."TshakeA:Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد المميز الى » "..Teext)
end
if text and text:match("^تغير رد العضو (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد العضو (.*)$") 
database:set(bot_id.."TshakeA:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"🔖┇ تم تغير رد العضو الى » "..Teext)
end


if text == ("مسح ردود المدير") and Owner(msg) then
local list = database:smembers(bot_id.."TshakeA:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."TshakeA:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."TshakeA:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."TshakeA:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."TshakeA:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."TshakeA:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."TshakeA:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."TshakeA:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."TshakeA:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."TshakeA:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."TshakeA:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق 🃏"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره 🎇"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف 📁"
elseif database:get(bot_id.."TshakeA:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
local test = database:get(bot_id.."TshakeA:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."TshakeA:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."TshakeA:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."TshakeA:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."TshakeA:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."TshakeA:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."TshakeA:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."TshakeA:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."TshakeA:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."TshakeA:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."TshakeA:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
if database:get(bot_id.."TshakeA:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."TshakeA:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."TshakeA:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."TshakeA:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."TshakeA:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."TshakeA:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."TshakeA:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."TshakeA:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."TshakeA:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."TshakeA:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."TshakeA:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."TshakeA:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TshakeA:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:del(bot_id.."TshakeA:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."TshakeA:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."TshakeA:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."TshakeA:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'TshakeA:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."TshakeA:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."TshakeA:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."TshakeA:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."TshakeA:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."TshakeA:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."TshakeA:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."TshakeA:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."TshakeA:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'TshakeA:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'TshakeA:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevTshakeA(msg) then 
local list = database:smembers(bot_id.."TshakeA:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."TshakeA:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."TshakeA:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."TshakeA:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."TshakeA:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."TshakeA:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."TshakeA:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."TshakeA:Add:Rd:Sudo:File"..v)
database:del(bot_id.."TshakeA:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."TshakeA:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"📌┇تم مسح ردود المطور")
end
if text == ("ردود المطور") and DevTshakeA(msg) then 
local list = database:smembers(bot_id.."TshakeA:List:Rd:Sudo")
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."TshakeA:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif database:get(bot_id.."TshakeA:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."TshakeA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."TshakeA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."TshakeA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."TshakeA:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."TshakeA:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."TshakeA:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."TshakeA:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."TshakeA:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."TshakeA:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."TshakeA:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."TshakeA:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"📌┇تم حفظ الرد بنجاح")
return false  
end  
...
if text == "اضف رد للكل" and DevTshakeA(msg) then 
send(msg.chat_id_, msg.id_,"📥┇ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."TshakeA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevTshakeA(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."TshakeA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TshakeA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."TshakeA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."TshakeA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."TshakeA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."TshakeA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"📌┇تم ازالة الرد من قائمه ردود المطور")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'TshakeA:'..v..text)
end
database:del(bot_id.."TshakeA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."TshakeA:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."TshakeA:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'TshakeA:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."TshakeA:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."TshakeA:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."TshakeA:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."TshakeA:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."TshakeA:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."TshakeA:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."TshakeA:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."TshakeA:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."TshakeA:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."TshakeA:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."TshakeA:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."TshakeA:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."TshakeA:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."TshakeA:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."TshakeA:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."TshakeA:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."TshakeA:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."TshakeA:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
function Function_TshakeA(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."TshakeA:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."TshakeA:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."TshakeA:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
if database:sismember(bot_id.."TshakeA:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."TshakeA:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."TshakeA:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."TshakeA:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "Chucky_A  ")
...
if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."TshakeA:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"📫┇ تم مغادرة المجموعه") 
database:srem(bot_id.."TshakeA:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."TshakeA:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevTshakeA(msg) then   
database:del(bot_id.."TshakeA:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"📫┇تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevTshakeA(msg) then  
database:set(bot_id.."TshakeA:Left:Bot"..msg.chat_id_,true)   
...
if DevTshakeA(msg) then
database:setex(bot_id.."TshakeA:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."TshakeA:Status:Bc") and not DevTshakeA(msg) then 
send(msg.chat_id_, msg.id_,"📫┇الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."TshakeA:TshakeA:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."TshakeA:TshakeA:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."TshakeA:TshakeA:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."TshakeA:TshakeA:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."TshakeA:TshakeA:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥┇ارسل لي التوجيه الان") 
return false
end 

if text == "تفعيل الاذاعه" and DevTshakeA(msg) then  
database:del(bot_id.."TshakeA:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevTshakeA(msg) then  
database:set(bot_id.."TshakeA:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n📫┇تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."TshakeA:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."TshakeA:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."TshakeA:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."TshakeA:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."TshakeA:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."TshakeA:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."TshakeA:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."TshakeA:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."TshakeA:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."TshakeA:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."TshakeA:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."TshakeA:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."TshakeA:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."TshakeA:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."TshakeA:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n🔰┇ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n🔏┇علامة ال {✓} تعني مفعل"..
...
if Owner(msg) then
database:del(bot_id.."TshakeA:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '📌┇تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."TshakeA:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء تعين الايدي") 
database:del(bot_id.."TshakeA:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."TshakeA:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."TshakeA:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
...
local Add_Mem = database:get(bot_id.."TshakeA:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."TshakeA:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'TshakeA:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'TshakeA:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'TshakeA:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."TshakeA:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'TshakeA:Lock:ID:Bot'..msg.chat_id_) then
...
database:incrby(bot_id.."TshakeA:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."TshakeA:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."TshakeA:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and DevTshakeA(msg) then
local pv = database:smembers(bot_id..'TshakeA:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'TshakeA:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and DevTshakeA(msg) then
local group = database:smembers(bot_id..'TshakeA:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'TshakeA:Chek:Groups',group[i])  
w = w + 1
end
...
download_to_file('https://raw.githubusercontent.com/ChuckyA1/ChuckyA/master/TshakeA.lua', 'TshakeA.lua') 
download_to_file('https://raw.githubusercontent.com/ChuckyA1/ChuckyA/master/start.lua', 'start.lua') 
dofile('TshakeA.lua')  
return false
end


if text == 'تفعيل البوت الخدمي' and DevTshakeA(msg) then  
database:del(bot_id..'TshakeA:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and DevTshakeA(msg) then  
database:set(bot_id..'TshakeA:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTshakeA(msg) then
local Num = text:match("تعين عدد الاعضاء (%d+)$") 
database:set(bot_id..'TshakeA:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'👥┇ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'TshakeA:Chek:Groups')  
local Users = database:scard(bot_id..'TshakeA:UsersBot')  
send(msg.chat_id_, msg.id_,'🔘┇احصائيات البوت \n\n👥┇عدد المجموعات *~ '..Groups..'\n👤┇عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevTshakeA(msg) then
local list = database:smembers(bot_id..'TshakeA:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'TshakeA Chat'
ASAS = database:smembers(bot_id.."TshakeA:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."TshakeA:Constructor"..v)
MDER = database:smembers(bot_id.."TshakeA:Manager"..v)
MOD = database:smembers(bot_id.."TshakeA:Mod:User"..v)
link = database:get(bot_id.."TshakeA:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"TshakeA":"'..NAME..'",'
else
t = t..',"'..v..'":{"TshakeA":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'TshakeA:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and DevTshakeA(msg) then
t = '☑┇جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls TshakeA_Files'):lines() do
if v:match(".lua$") then
...
if DevTshakeA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TshakeAab/files_TshakeA/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات تشاكي A\n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n📌┇تدل علامة (✔) الملف مفعل\n".."📌┇تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("TshakeA_Files/"..name,"r")
...
local file_bot = io.open("TshakeA_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/TshakeAab/files_TshakeA/master/files_TshakeA/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevTshakeA(msg) then
...
if text == "مسح جميع الملفات" and DevTshakeA(msg) then
os.execute("rm -fr TshakeA_Files/*")
send(msg.chat_id_,msg.id_,"☑┇تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevTshakeA(msg) then
local Users = database:smembers('TshakeA:'..bot_id.."userss")
...
if text == 'حذف كليشه المطور' and DevTshakeA(msg) then
database:del(bot_id..'TshakeA:Text_Dev')
...
if text == 'رفع النسخه الاحتياطيه' and DevTshakeA(msg) then   
...
if text == "تحديث" and DevTshakeA(msg) then
dofile("TshakeA.lua")  
send(msg.chat_id_, msg.id_, "☑┇تم التحديث")
end
...
🌐┇TshakeA TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/Chucky_A)

📋┇ [TshakeA Dev](https://t.me/Chucky_A  )

📁┇ [Source  Files](https://t.me/TshakeA_sudo)

🌐┇ [TshakeA iNDT](https://t.me/Chucky_A)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS TshakeA](https://t.me/RIOKNBOT)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'TshakeA:Num:Add:Bot') or 0) and not DevTshakeA(msg) then
send(msg.chat_id_, msg.id_,'👥┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'TshakeA:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
database:set(bot_id.."TshakeA:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
Reply_Status(msg,result.id_,'reply_Add','☑┇تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'TshakeA:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'TshakeA:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'TshakeA:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'TshakeA:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevTshakeA(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if DevTshakeA(msg) and msg.reply_to_message_id_ ~= 0  then    
...
database:srem(bot_id..'TshakeA:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
if text and not database:sismember(bot_id..'TshakeA:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'TshakeA:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'TshakeA:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."TshakeA:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."TshakeA:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."TshakeA:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."TshakeA:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."TshakeA:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."TshakeA:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."TshakeA:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."TshakeA:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."TshakeA:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
------------------------------------------------------------------------
TshakeA_Started_Bot(msg,data)
TshakeA_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'TshakeA:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."TshakeA:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
if database:get(bot_id.."TshakeA:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."TshakeA:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."TshakeA:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."TshakeA:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local TshakeA_Msg = database:get(bot_id.."TshakeA:Add:Filter:Rp2"..text..result.chat_id_)   
if TshakeA_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..TshakeA_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'TshakeA:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'TshakeA:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'TshakeA:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'TshakeA:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'TshakeA:Chek:Groups',v)  
end
...
database:sadd(bot_id..'TshakeA:Chek:Groups',v)  
end end,nil)
