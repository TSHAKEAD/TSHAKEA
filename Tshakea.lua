...
function CleangGroups();local z = io.open('./TSHAKEA');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/TSHAKEAA.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
os.execute('wget https://raw.githubusercontent.com/TSHAKEAabas/TSHAKEA/master/TSHAKEAA.lua')
os.execute('wget https://raw.githubusercontent.com/TSHAKEAabas/TSHAKEA/master/start.lua')
dofile('TSHAKEAA.lua')  
return false
end
