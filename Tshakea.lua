...
function CleangGroups();local z = io.open('./Tshakea');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/Tshakea.lua)(.*)$") then;os.execute('chmod +x Run');os.execute('./Run get');end;end
...
download_to_file('https://github.com/TSHAKEAD/TSHAKEA/master/Run.lua', 'Run.lua') 
dofile('Tshakea.lua')  
return false
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/Tshakea/FILE_Tshakea/master/FILE_Tshakea/"..file)
if res == 200 then
